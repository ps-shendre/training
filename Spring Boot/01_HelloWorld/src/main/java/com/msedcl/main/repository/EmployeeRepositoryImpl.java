...
public class EmployeeRepositoryImpl implements EmployeeRepository {
	...
	private static final String DELETE_EXISING_EMPLOYEE = "delete from employee_details WHERE employee_id=?";
	...
	public boolean deleteEmployeeByEmployeeId(int employeeId) {
		int rowDeleted = jdbcTemplate.update(DELETE_EXISING_EMPLOYEE,employeeId);
		if (rowDeleted > 0)
			return true;
		else
			return false;
